...
/**
 * A class that implements a heap collection using an array data structure,
 * where a node at index i has its left child stored at index 2i+1 and its right
 * child stored at index 2i+2, so its parent is at index (i-1)/2
 *
 * @author Andrew Ensor
 */
